import { registerCommands, AliucordSectionID, Command, ApplicationCommandInputType, ApplicationCommandType, ApplicationCommandOptionType } from "aliucord-api/commands";
